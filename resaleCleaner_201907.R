...
dirIn  <-("C:/Users/LeeB/Documents/Resale/2019/2019_09/Raw_092719/")
dirOut <-("C:/Users/LeeB/Documents/Resale/2019/2019_09/Clean_092719/")
...
ds$AUCTIONSTARTDATE[ds$PARTICIPANTCODE %in% c('TRUKACCESS','CRANETRCOM')]<-paste0(mon,"/21/",yr)
...
ds$CURRENCY[ds$PARTICIPANTCODE %in% c('CRANETRADE','CRANETRADER','VOLVORM','USEDGENIE')] <- "USD"
...
dd<-ds[ds$PARTICIPANTCODE %in% c('CTT','MACHPETE','RCKANDDIRT','ELS','MASCUS','UNITEDRENT','CONTRHTLN','FASTLINE','HertzEquip','AMERICANAG','POINT2USED',
                             ...
                             'CATUSED','EQPSELLSIT','NFLEXCH','BIGGE','DTCHWTCH','WNEUSONWI','CRANETRADER','ILLINOISLIFTEQUIP','CRANETRCOM'),]
